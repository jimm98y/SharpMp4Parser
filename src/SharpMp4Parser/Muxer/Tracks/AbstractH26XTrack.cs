...
namespace SharpMp4Parser.Muxer.Tracks
{
    ...
    public abstract class AbstractH26XTrack : AbstractTrack
    {
        ...
        protected bool allZeroIsEndOfSequence = true;
        private DataSource dataSource;

        public AbstractH26XTrack(DataSource dataSource, bool allZeroIsEndOfSequence) : base(dataSource.ToString())
        {
            this.dataSource = dataSource;
            this.allZeroIsEndOfSequence = allZeroIsEndOfSequence;
        }
        ...
        protected virtual ByteBuffer findNextNal(LookAhead la)
        {
            try
            {
                ...
                while (!la.nextThreeEquals000or001orEof(allZeroIsEndOfSequence))
                {
                    la.discardByte();
                }
                return la.getNal();
