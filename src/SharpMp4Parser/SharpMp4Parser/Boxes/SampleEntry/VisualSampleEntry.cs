...
namespace SharpMp4Parser.Boxes.SampleEntry
{
     ...
     */
    public sealed class VisualSampleEntry : AbstractSampleEntry, Container
    {
        ...
        public VisualSampleEntry() : base(TYPE3)
        { }

        public VisualSampleEntry(string type) : base(type)
        { }
        ...
        public override void parse(ReadableByteChannel dataSource, ByteBuffer header, long contentSize, BoxParser boxParser)
        {
            ...
            Debug.Assert(0 == tmp, "reserved byte not 0");
            ...
            byte[]
            bytes = new byte[compressornameDisplayAbleData];
            content.get(bytes);
        ...
        public override bool Equals(object o)
        {
            ...
            return Enumerable.SequenceEqual(baos1.toByteArray(), baos2.toByteArray());
        }
