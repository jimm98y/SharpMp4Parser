...
namespace SharpMp4Parser.Boxes.ISO14496.Part12
{
     ...
     */
    public class FileTypeBox : AbstractBox
    {
        ...
        public FileTypeBox() : base(TYPE)
        { }

        public FileTypeBox(string majorBrand, long minorVersion, List<string> compatibleBrands) : base(TYPE)
        {
