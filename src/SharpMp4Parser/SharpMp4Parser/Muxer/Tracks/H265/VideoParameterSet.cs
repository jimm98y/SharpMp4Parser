...
namespace SharpMp4Parser.Muxer.Tracks.H265
{
    public class VideoParameterSet
    {
        ...
        public VideoParameterSet(ByteBuffer vps)
        {
            ...
            bool vps_temporal_id_nesting_flag = r.readBool("vps_temporal_id_nesting_flag");
            int vps_reserved_0xffff_16bits = r.readU(16, "vps_reserved_0xffff_16bits");
            profile_tier_level(vps_max_sub_layers_minus1, r);


            bool vps_sub_layer_ordering_info_present_flag = r.readBool("vps_sub_layer_ordering_info_present_flag");
            ...
            bool[,] layer_id_included_flag = new bool[vps_num_layer_sets_minus1, vps_max_layer_id];
            ...
            bool vps_extension_flag = r.readBool("vps_extension_flag");
            if (vps_extension_flag)
            {
                while (r.moreRBSPData())
                {
                    bool vps_extension_data_flag = r.readBool("vps_extension_data_flag");
                }
            }
            r.readTrailingBits();
        ...
        public void profile_tier_level(int maxNumSubLayersMinus1, CAVLCReader r)
        {
        ...
        private void hrd_parameters(bool commonInfPresentFlag, int maxNumSubLayersMinus1, CAVLCReader r)
        {
            ...
            if (commonInfPresentFlag)
            {
                ...
                if (nal_hrd_parameters_present_flag || vcl_hrd_parameters_present_flag)
                {
                    ...
                    if (sub_pic_hrd_params_present_flag)
                    {
                        ...
                        bool sub_pic_cpb_params_in_pic_timing_sei_flag = r.readBool("sub_pic_cpb_params_in_pic_timing_sei_flag");
            ...
            bool[] fixed_pic_rate_general_flag = new bool[maxNumSubLayersMinus1];
            bool[] fixed_pic_rate_within_cvs_flag = new bool[maxNumSubLayersMinus1];
            bool[] low_delay_hrd_flag = new bool[maxNumSubLayersMinus1];
        ...
        void sub_layer_hrd_parameters(int subLayerId, int cpbCnt, bool sub_pic_hrd_params_present_flag, CAVLCReader r)
        {
