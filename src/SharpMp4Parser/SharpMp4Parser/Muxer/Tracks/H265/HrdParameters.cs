...
namespace SharpMp4Parser.Muxer.Tracks.H265
{
    ...
    {
        public HrdParameters(bool commonInfPresentFlag, int maxNumSubLayersMinus1, CAVLCReader bsr)
        {
            ...
            if (commonInfPresentFlag)
            {
                ...
                if (nal_hrd_parameters_present_flag || vcl_hrd_parameters_present_flag)
                {
                    ...
                    if (sub_pic_hrd_params_present_flag)
                    {
                        ...
                        bool sub_pic_cpb_params_in_pic_timing_sei_flag = bsr.readBool("sub_pic_cpb_params_in_pic_timing_sei_flag");
