...
{
    public sealed class IsoTypeWriter
    {
        public static void writeUInt64(ByteBuffer bb, long u)
        {
            Debug.Assert(u >= 0, "The given long is negative");
            bb.putLong(u);
        }
...
#warning review this - putUint?
        ...
        public static void writePascalUtfString(ByteBuffer bb, string str)
        {
            byte[] b = Utf8.convert(str);
            Debug.Assert(b.Length < 255);
            writeUInt8(bb, b.Length);
            bb.put(b);
        }

        public static void writeZeroTermUtf8String(ByteBuffer bb, string str)
        {
            byte[] b = Utf8.convert(str);
            bb.put(b);
            writeUInt8(bb, 0);
        ...
        public static void writeUtf8String(ByteBuffer bb, string str)
        {
            bb.put(Utf8.convert(str));
            writeUInt8(bb, 0);
        }
    }
}
