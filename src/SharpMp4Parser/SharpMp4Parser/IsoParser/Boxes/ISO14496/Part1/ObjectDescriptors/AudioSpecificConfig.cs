...
{
    [Descriptor(Tags = new int[] { 0x5 }, ObjectTypeIndication = 0x40)]
    public class AudioSpecificConfig : BaseDescriptor
    {
        public static Dictionary<int, int> samplingFrequencyIndexMap = new Dictionary<int, int>();
        public static Dictionary<int, string> audioObjectTypeMap = new Dictionary<int, string>();

        static AudioSpecificConfig()
        {
            ...
            41 SMR Main
            */
            audioObjectTypeMap.Add(1, "AAC main");
            audioObjectTypeMap.Add(2, "AAC LC");
            audioObjectTypeMap.Add(3, "AAC SSR");
            audioObjectTypeMap.Add(4, "AAC LTP");
            audioObjectTypeMap.Add(5, "SBR");
            audioObjectTypeMap.Add(6, "AAC Scalable");
            audioObjectTypeMap.Add(7, "TwinVQ");
            audioObjectTypeMap.Add(8, "CELP");
            audioObjectTypeMap.Add(9, "HVXC");
            audioObjectTypeMap.Add(10, "(reserved)");
            audioObjectTypeMap.Add(11, "(reserved)");
            audioObjectTypeMap.Add(12, "TTSI");
            audioObjectTypeMap.Add(13, "Main synthetic");
            audioObjectTypeMap.Add(14, "Wavetable synthesis");
            audioObjectTypeMap.Add(15, "General MIDI");
            audioObjectTypeMap.Add(16, "Algorithmic Synthesis and Audio FX");
            audioObjectTypeMap.Add(17, "ER AAC LC");
            audioObjectTypeMap.Add(18, "(reserved)");
            audioObjectTypeMap.Add(19, "ER AAC LTP");
            audioObjectTypeMap.Add(20, "ER AAC Scalable");
            audioObjectTypeMap.Add(21, "ER TwinVQ");
            audioObjectTypeMap.Add(22, "ER BSAC");
            audioObjectTypeMap.Add(23, "ER AAC LD");
            audioObjectTypeMap.Add(24, "ER CELP");
            audioObjectTypeMap.Add(25, "ER HVXC");
            audioObjectTypeMap.Add(26, "ER HILN");
            audioObjectTypeMap.Add(27, "ER Parametric");
            audioObjectTypeMap.Add(28, "SSC");
            audioObjectTypeMap.Add(29, "PS");
            audioObjectTypeMap.Add(30, "MPEG Surround");
            audioObjectTypeMap.Add(31, "(escape)");
            audioObjectTypeMap.Add(32, "Layer-1");
            audioObjectTypeMap.Add(33, "Layer-2");
            audioObjectTypeMap.Add(34, "Layer-3");
            audioObjectTypeMap.Add(35, "DST");
            audioObjectTypeMap.Add(36, "ALS");
            audioObjectTypeMap.Add(37, "SLS");
            audioObjectTypeMap.Add(38, "SLS non-core");
            audioObjectTypeMap.Add(39, "ER AAC ELD");
            audioObjectTypeMap.Add(40, "SMR Simple");
            audioObjectTypeMap.Add(41, "SMR Main");
        ...
        public bool sbrPresentFlag;
        public bool psPresentFlag;
        ...
        public bool aacSectionDataResilienceFlag;
        public bool aacScalefactorDataResilienceFlag;
        public bool aacSpectralDataResilienceFlag;
        public int extensionFlag3;
        public bool gaSpecificConfig;
        ...
        public override void parseDetail(ByteBuffer bb)
        {
            ...
            switch (audioObjectType)
            {
                ...
                case 23:
                    ...
                    break;
                case 8:
                    throw new NotSupportedException("can't parse CelpSpecificConfig yet");
                //CelpSpecificConfig();
                //break;
                case 9:
                    throw new NotSupportedException("can't parse HvxcSpecificConfig yet");
                //HvxcSpecificConfig();
                //break;
                case 12:
                    throw new NotSupportedException("can't parse TTSSpecificConfig yet");
                //TTSSpecificConfig();
                //break;
                case 13:
                case 14:
                case 15:
                case 16:
                    throw new NotSupportedException("can't parse StructuredAudioSpecificConfig yet");
                //StructuredAudioSpecificConfig();
                //break;
                case 24:
                    throw new NotSupportedException("can't parse ErrorResilientCelpSpecificConfig yet");
                //ErrorResilientCelpSpecificConfig();
                //break;
                case 25:
                    throw new NotSupportedException("can't parse ErrorResilientHvxcSpecificConfig yet");
                ...
                case 27:
                    ...
                    break;
                case 28:
                    throw new NotSupportedException("can't parse SSCSpecificConfig yet");
                //SSCSpecificConfig();
                //break;
                case 30:
                    sacPayloadEmbedding = bitReaderBuffer.readBits(1);
                    throw new NotSupportedException("can't parse SpatialSpecificConfig yet");
                //SpatialSpecificConfig();
                //break;
                case 32:
                case 33:
                case 34:
                    throw new NotSupportedException("can't parse MPEG_1_2_SpecificConfig yet");
                //MPEG_1_2_SpecificConfig();
                //break;
                case 35:
                    throw new NotSupportedException("can't parse DSTSpecificConfig yet");
                //DSTSpecificConfig();
                //break;
                case 36:
                    fillBits = bitReaderBuffer.readBits(5);
                    throw new NotSupportedException("can't parse ALSSpecificConfig yet");
                //ALSSpecificConfig();
                //break;
                case 37:
                case 38:
                    throw new NotSupportedException("can't parse SLSSpecificConfig yet");
                //SLSSpecificConfig();
                //break;
                case 39:
                ...
                case 40:
                case 41:
                    throw new NotSupportedException("can't parse SymbolicMusicSpecificConfig yet");
            ...
            switch (audioObjectType)
            {
                ...
                case 39:
                    ...
                    {
                        throw new NotSupportedException("can't parse ErrorProtectionSpecificConfig yet");
        ...
        private int gaSpecificConfigSize()
        {
            ...
            {
                throw new NotSupportedException("can't parse program_config_element yet");
        ...
        {
            ByteBuffer output = ByteBuffer.wrap(new byte[getContentSize()]);
            BitWriterBuffer bitWriterBuffer = new BitWriterBuffer(output);
            ...
            switch (audioObjectType)
            {
                ...
                case 23:
                    ...
                    break;
                case 8:
                    throw new NotSupportedException("can't write CelpSpecificConfig yet");
                //CelpSpecificConfig();
                //break;
                case 9:
                    throw new NotSupportedException("can't write HvxcSpecificConfig yet");
                //HvxcSpecificConfig();
                //break;
                case 12:
                    throw new NotSupportedException("can't write TTSSpecificConfig yet");
                //TTSSpecificConfig();
                //break;
                case 13:
                case 14:
                case 15:
                case 16:
                    throw new NotSupportedException("can't write StructuredAudioSpecificConfig yet");
                //StructuredAudioSpecificConfig();
                //break;
                case 24:
                    throw new NotSupportedException("can't write ErrorResilientCelpSpecificConfig yet");
                //ErrorResilientCelpSpecificConfig();
                //break;
                case 25:
                    throw new NotSupportedException("can't write ErrorResilientHvxcSpecificConfig yet");
                //ErrorResilientHvxcSpecificConfig();
                //break;
                case 26:
                case 27:
                    throw new NotSupportedException("can't write parseParametricSpecificConfig yet");
                // parseParametricSpecificConfig(samplingFrequencyIndex, channelConfiguration, audioObjectType, bitWriterBuffer);
                // ParametricSpecificConfig();
                // break;
                case 28:
                    throw new NotSupportedException("can't write SSCSpecificConfig yet");
                //SSCSpecificConfig();
                //break;
                case 30:
                    bitWriterBuffer.writeBits(sacPayloadEmbedding, 1);
                    throw new NotSupportedException("can't write SpatialSpecificConfig yet");
                //SpatialSpecificConfig();
                //break;
                case 32:
                case 33:
                case 34:
                    throw new NotSupportedException("can't write MPEG_1_2_SpecificConfig yet");
                //MPEG_1_2_SpecificConfig();
                //break;
                case 35:
                    throw new NotSupportedException("can't write DSTSpecificConfig yet");
                //DSTSpecificConfig();
                //break;
                case 36:
                    bitWriterBuffer.writeBits(fillBits, 5);
                    throw new NotSupportedException("can't write ALSSpecificConfig yet");
                //ALSSpecificConfig();
                //break;
                case 37:
                case 38:
                    throw new NotSupportedException("can't write SLSSpecificConfig yet");
                //SLSSpecificConfig();
                //break;
                case 39:
                    throw new NotSupportedException("can't write ELDSpecificConfig yet");
        ...
        private static int getAudioObjectType(BitReaderBuffer input)
        {
            int audioObjectType = input.readBits(5);
            if (audioObjectType == 31)
            {
                audioObjectType = 32 + input.readBits(6);
            }
            return audioObjectType;
        }

        private void parseGaSpecificConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            //    GASpecificConfig (samplingFrequencyIndex,
            //            channelConfiguration,
            //            audioObjectType)
            //    {
            frameLengthFlag = input.readBits(1);
            dependsOnCoreCoder = input.readBits(1);
            if (dependsOnCoreCoder == 1)
            {
                coreCoderDelay = input.readBits(14);
            }
            extensionFlag = input.readBits(1);
            if (channelConfiguration == 0)
            {
                throw new NotSupportedException("can't parse program_config_element yet");
                //program_config_element ();
            ...
            if (audioObjectType == 6 || audioObjectType == 20)
            {
                layerNr = input.readBits(3);
            }
            if (extensionFlag == 1)
            {
                if (audioObjectType == 22)
                {
                    numOfSubFrame = input.readBits(5);
                    layer_length = input.readBits(11);
                }
                if (audioObjectType == 17 || audioObjectType == 19 ||
                        audioObjectType == 20 || audioObjectType == 23)
                {
                    aacSectionDataResilienceFlag = input.readBool();
                    aacScalefactorDataResilienceFlag = input.readBool();
                    aacSpectralDataResilienceFlag = input.readBool();
                }
                extensionFlag3 = input.readBits(1);
                if (extensionFlag3 == 1)
                {
        ...
        private void writeGaSpecificConfig(BitWriterBuffer output)
        {
            //    GASpecificConfig (samplingFrequencyIndex,
            //            channelConfiguration,
            //            audioObjectType)
            //    {
            output.writeBits(frameLengthFlag, 1); // frameLengthFlag = in.readBits(1);
            output.writeBits(dependsOnCoreCoder, 1); //= in.readBits(1);
            if (dependsOnCoreCoder == 1)
            {
                output.writeBits(coreCoderDelay, 14); // = in.readBits(14);
            }
            output.writeBits(extensionFlag, 1); // = in.readBits(1);
            if (channelConfiguration == 0)
            {
                throw new NotSupportedException("can't parse program_config_element yet");
                //program_config_element ();
            ...
            if (audioObjectType == 6 || audioObjectType == 20)
            {
                output.writeBits(layerNr, 3);// = in.readBits(3);
            }
            if (extensionFlag == 1)
            {
                if (audioObjectType == 22)
                {
                    output.writeBits(numOfSubFrame, 5); // = in.readBits(5);
                    output.writeBits(layer_length, 11); // = in.readBits(11);
                }
                if (audioObjectType == 17 || audioObjectType == 19 ||
                        audioObjectType == 20 || audioObjectType == 23)
                {
                    output.writeBool(aacSectionDataResilienceFlag); // = in.readBool();
                    output.writeBool(aacScalefactorDataResilienceFlag); // = in.readBool();
                    output.writeBool(aacSpectralDataResilienceFlag); // = in.readBool();
                }
                output.writeBits(extensionFlag3, 1); // = in.readBits(1);
                if (extensionFlag3 == 1)
                {
                    throw new NotImplementedException("not yet implemented");
                }
        ...
        private void parseParametricSpecificConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            /*
            ParametricSpecificConfig() {
            ...
            */
            isBaseLayer = input.readBits(1);
            if (isBaseLayer == 1)
            {
                parseParaConfig(samplingFrequencyIndex, channelConfiguration, audioObjectType, input);
            }
            else
            {
                parseHilnEnexConfig(samplingFrequencyIndex, channelConfiguration, audioObjectType, input);
            }
        }

        private void parseParaConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            /*
            PARAconfig()
            {
            ...
            */
            paraMode = input.readBits(2);

            if (paraMode != 1)
            {
                parseErHvxcConfig(samplingFrequencyIndex, channelConfiguration, audioObjectType, input);
            }
            if (paraMode != 0)
            {
                parseHilnConfig(samplingFrequencyIndex, channelConfiguration, audioObjectType, input);
            }

            paraExtensionFlag = input.readBits(1);
            parametricSpecificConfig = true;
        }

        private void parseErHvxcConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            /*
            ErHVXCconfig()
            {
            ...
            */
            hvxcVarMode = input.readBits(1);
            hvxcRateMode = input.readBits(2);
            erHvxcExtensionFlag = input.readBits(1);

            if (erHvxcExtensionFlag == 1)
            {
                var_ScalableFlag = input.readBits(1);
            }
        }

        private void parseHilnConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            /*
            HILNconfig()
            {
            ...
            */
            hilnQuantMode = input.readBits(1);
            hilnMaxNumLine = input.readBits(8);
            hilnSampleRateCode = input.readBits(4);
            hilnFrameLength = input.readBits(12);
            hilnContMode = input.readBits(2);
        }

        private void parseHilnEnexConfig(int samplingFrequencyIndex, int channelConfiguration, int audioObjectType, BitReaderBuffer input)
        {
            /*
            HILNenexConfig()
            {
            ...
            */
            hilnEnhaLayer = input.readBits(1);
            if (hilnEnhaLayer == 1)
            {
                hilnEnhaQuantMode = input.readBits(2);
            }
        }
        ...
        public override bool Equals(object o)
        {
            ...
            if (!configBytes.SequenceEqual(that.configBytes))
            {
                return false;
            }
        ...
        {
            private const int ELDEXT_TERM = 0x0;//0b0000;
            public bool frameLengthFlag;
            public bool aacSectionDataResilienceFlag;
            public bool aacScalefactorDataResilienceFlag;
            public bool aacSpectralDataResilienceFlag;
            public bool ldSbrPresentFlag;
            public bool ldSbrSamplingRate;
            public bool ldSbrCrcFlag;

            public ELDSpecificConfig(int channelConfiguration, BitReaderBuffer bitReaderBuffer)
            {

                frameLengthFlag = bitReaderBuffer.readBool();
                aacSectionDataResilienceFlag = bitReaderBuffer.readBool();
                aacScalefactorDataResilienceFlag = bitReaderBuffer.readBool();
                aacSpectralDataResilienceFlag = bitReaderBuffer.readBool();

                ldSbrPresentFlag = bitReaderBuffer.readBool();
                if (ldSbrPresentFlag)
                {
        ...
        public class sbr_header
        {
            ...
            public bool bs_header_extra_1;
            public bool bs_header_extra_2;
