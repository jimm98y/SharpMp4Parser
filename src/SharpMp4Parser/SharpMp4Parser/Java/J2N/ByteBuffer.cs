...
namespace SharpMp4Parser.Java
{
    ...
    public abstract class ByteBuffer : Buffer, IComparable<ByteBuffer>
    {
        ...
        /// </summary>
        internal Endianness _order = Endianness.BigEndian;
        ...
        {
            return _order == Endianness.BigEndian ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN;
        }
        ...
        {
            _order = byteOrder == ByteOrder.BIG_ENDIAN ? Endianness.BigEndian
        ...
        public virtual void put(Buffer buffer)
        {
