...
namespace SharpMp4Parser.Java
{
    ...
    public abstract class Buffer : Closeable
    {
        ...
        /// Limit must be no less than zero and no greater than <see cref="_capacity"/>.
        /// </summary>
        internal int _limit;
        ...
        /// greater than <see cref="_position"/>.
        /// </summary>
        internal int _mark = UnsetMark;

        /// <summary>
        /// The current position of this buffer. Position is always no less than zero
        /// and no greater than <see cref="_limit"/>.
        /// </summary>
        ...
        public Buffer limit(int newLimit)
        {
            ...
            if ((_mark != UnsetMark) && (_mark > newLimit))
            {
                _mark = UnsetMark;
            }
            return this;
        ...
        public Buffer position(long newPosition)
        {
            ...
            if ((_mark != UnsetMark) && (_mark > _position))
            {
                _mark = UnsetMark;
            }
            return this;
        ...
        /// <summary>
        /// Resets the position of this buffer to the <see cref="_mark"/>.
        /// </summary>
        /// <returns>This buffer</returns>
